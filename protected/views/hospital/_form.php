...
$this->widget('ToolbarButton',array(
	'isSave'=>true,'UrlSave'=>'hospital/write',
	'isCancel'=>true,'UrlCancel'=>'hospital/cancelwrite'
));
?>
          ...
          $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
              ...
              /* Here is The Button that will send the Data to The MAIN FORM */
                ...
                "id" => "send_addresstype",
                "onClick" => "$(\"#account_dialog\").dialog(\"close\"); $(\"#accpiutangname\").val(\"$data->accountname\"); $(\"#Hospital_accpiutangid\").val(\"$data->accountid\");"))',
                ),
...
<?php
	...
	'tabs' => array(
		'Address' => array('content' => $this->renderPartial('indexaddress',
			array('hospitaladdress'=>$hospitaladdress),true)),
		'Contact' => array('content' => $this->renderPartial('indexcontact',
			array('hospitalcontact'=>$hospitalcontact),true)),
	),
