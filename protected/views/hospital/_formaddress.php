...
$this->widget('ToolbarButton',array(
	...
	'isSave'=>true,'UrlSave'=>'hospital/writeaddress',
	'isCancel'=>true,'UrlCancel'=>'hospital/cancelwriteaddress'
));
?>
          ...
          $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
              ...
              /* Here is The Button that will send the Data to The MAIN FORM */
                ...
                "id" => "send_addresstype",
                "onClick" => "$(\"#addresstype_dialog\").dialog(\"close\"); $(\"#addresstype_name\").val(\"$data->addresstypename\"); $(\"#Hospitaladdress_addresstypeid\").val(\"$data->addresstypeid\");"))',
                ),
          ...
          $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
              ...
              /* Here is The Button that will send the Data to The MAIN FORM */
                ...
                "id" => "send_city",
                "onClick" => "$(\"#city_dialog\").dialog(\"close\"); $(\"#city_name\").val(\"$data->cityname\"); $(\"#Hospitaladdress_cityid\").val(\"$data->cityid\");"))',
                ),
          ...
          $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
              ...
              /* Here is The Button that will send the Data to The MAIN FORM */
                ...
                "id" => "send_kelurahan",
                "onClick" => "$(\"#kelurahan_dialog\").dialog(\"close\"); $(\"#kelurahan_name\").val(\"$data->kelurahanname\"); $(\"#Hospitaladdress_kelurahanid\").val(\"$data->kelurahanid\");"))',
                ),
          ...
          $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
              ...
              /* Here is The Button that will send the Data to The MAIN FORM */
                ...
                "id" => "send_subdistrict",
                "onClick" => "$(\"#subdistrict_dialog\").dialog(\"close\"); $(\"#subdistrict_name\").val(\"$data->subdistrictname\"); $(\"#Hospitaladdress_subdistrictid\").val(\"$data->subdistrictid\");"))',
                ),
