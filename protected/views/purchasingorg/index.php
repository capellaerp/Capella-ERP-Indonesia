...
function helpdata(value) {
	jQuery.ajax({
        'url': '/index.php?r=purchasingorg/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
<script type="text/javascript" >
	$(function(){
		...
		new AjaxUpload(btnUpload, {
			action: 'index.php?r=purchasingorg/upload',
			name: 'uploadfile',
...
$this->widget('application.extensions.tipsy.Tipsy', array(
  ...
  'gravity' => 'n',
  'items' => array(
    array('id' => array('model' => $model, 'attribute' => 'purchasingorgcode')
     ,'fallback' => Catalogsys::model()->getcatalog('enterpurchasingorgcode'),'html'=>true),    
...
$this->widget('ToolbarButton',array('isCreate'=>true,'isEdit'=>true,'isDelete'=>true,
	'isUpload'=>true,'UrlUpload'=>'index.php?r=purchasingorg/upload',
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	array('name'=>'purchasingorgid', 'visible'=>false,'header'=>'ID','value'=>'$data->purchasingorgid','htmlOptions'=>array('width'=>'1%')),
	array('name'=>'purchasingorgcode', 'value'=>'$data->purchasingorgcode','htmlOptions'=>array('width'=>'1%')),
	'description',
    array(
      'class'=>'CCheckBoxColumn',
      'name'=>'recordstatus',
