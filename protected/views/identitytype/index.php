...
function helpdata(value) {
	jQuery.ajax({
        'url': '/index.php?r=identitytype/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/index.php?r=identitytype/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<?php
$this->widget('application.extensions.tipsy.Tipsy', array(
  ...
  'gravity' => 'n',
  'items' => array(
    array('id' => array('model' => $model, 'attribute' => 'identitytypename')
     ,'fallback' => Catalogsys::model()->getcatalog('enteridentitytypename'),'html'=>true),    
...
<div id="divhelp"></div>
<?php $this->endWidget();?>
<h1><?php echo Catalogsys::model()->GetCatalog('identitytype') ?></h1>
<?php
$this->widget('ToolbarButton',array('isCreate'=>true,'isEdit'=>true,'isDelete'=>true,
	'isUpload'=>true,'UrlUpload'=>'index.php?r=identitytype/upload',
