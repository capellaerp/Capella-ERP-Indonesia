...
<script type="text/javascript" >
	$(function(){
		...
		new AjaxUpload(btnUpload, {
			action: 'index.php?r=workflow/upload',
			name: 'uploadfile',
...
function downloaddata() {
	window.open('/index.php?r=workflow/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<?php
$this->widget('application.extensions.tipsy.Tipsy', array(
  ...
  'gravity' => 'n',
  'items' => array(
    array('id' => array('model' => $model, 'attribute' => 'wfname')
     ,'fallback' => Catalogsys::model()->getcatalog('enterwfname'),'html'=>true),    
    array('id' => array('model' => $model, 'attribute' => 'wfdesc')
     ,'fallback' => Catalogsys::model()->getcatalog('enterwfdesc'),'html'=>true),    
    array('id' => array('model' => $model, 'attribute' => 'wfminstat')
     ,'fallback' => Catalogsys::model()->getcatalog('enterwfminstat'),'html'=>true),    
    array('id' => array('model' => $model, 'attribute' => 'wfmaxstat')
     ,'fallback' => Catalogsys::model()->getcatalog('enterwfmaxstat'),'html'=>true),    
