...
<script type="text/javascript" >
	$(function(){
		...
		new AjaxUpload(btnUpload, {
			action: 'index.php?r=language/upload',
			name: 'uploadfile',
...
function downloaddata() {
	window.open('/index.php?r=language/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<?php
$this->widget('application.extensions.tipsy.Tipsy', array(
  ...
  'gravity' => 'n',
  'items' => array(
    array('id' => array('model' => $model, 'attribute' => 'languagename')
     ,'fallback' => Catalogsys::model()->getcatalog('enterlanguagename'),'html'=>true),    
...
$this->widget('zii.widgets.grid.CGridView', array(
  ...
  'selectableRows'=>1,
	...
	array('name'=>'languageid', 'visible'=>false,'header'=>'ID','value'=>'$data->languageid','htmlOptions'=>array('width'=>'1%')),
		'languagename',
    array(
      'class'=>'CCheckBoxColumn',
      'name'=>'recordstatus',
