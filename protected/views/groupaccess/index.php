...
function editdata() {
    jQuery.ajax({
        'url': '/index.php?r=groupaccess/update',
        'data': {
...
<script type="text/javascript">
function deletedata()
{jQuery.ajax({'url':'/index.php?r=groupaccess/delete','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
...
function helpdata(value) {
	jQuery.ajax({
        'url': '/index.php?r=groupaccess/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
<script type="text/javascript" >
	$(function(){
		...
		new AjaxUpload(btnUpload, {
			action: 'index.php?r=groupaccess/upload',
			name: 'uploadfile',
...
$this->widget('application.extensions.tipsy.Tipsy', array(
  ...
  'gravity' => 'n',
  'items' => array(
    array('id' => array('model' => $model, 'attribute' => 'groupname')
     ,'fallback' => Catalogsys::model()->getcatalog('entergroupname'),'html'=>true),    
