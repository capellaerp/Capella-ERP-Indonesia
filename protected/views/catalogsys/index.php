...
function adddata()
{jQuery.ajax({'url':'/index.php?r=catalogsys/create','data':$(this).serialize(),'type':'post','dataType':'json','success':function(data)
...
<script type="text/javascript">
function editdata()
{jQuery.ajax({'url':'/index.php?r=catalogsys/update','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
{document.getElementById('messages').innerHTML='';if(data.status=='success')
{$('#createdialog div.divcreate').html(data.div);
...
<script type="text/javascript">
function deletedata()
{jQuery.ajax({'url':'/index.php?r=catalogsys/delete','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
...
function helpdata(value) {
	jQuery.ajax({
        'url': '/index.php?r=catalogsys/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
<script type="text/javascript" >
	$(function(){
		...
		new AjaxUpload(btnUpload, {
			action: 'index.php?r=catalogsys/upload',
			name: 'uploadfile',
...
function downloaddata() {
	window.open('/index.php?r=catalogsys/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<?php
$this->widget('application.extensions.tipsy.Tipsy', array(
  ...
  array('id' => '#languagename','fallback' => Catalogsys::model()->getcatalog('enterpoplanguagename'),'html'=>true), 
    ...
    array('id' => array('model' => $model, 'attribute' => 'catalogname')
     ,'fallback' => Catalogsys::model()->getcatalog('entercatalogname'),'html'=>true),    
    array('id' => array('model' => $model, 'attribute' => 'catalogval')
     ,'fallback' => Catalogsys::model()->getcatalog('entercatalogval'),'html'=>true),    
...
$this->widget('ToolbarButton',array('isCreate'=>true,'isEdit'=>true,'isDelete'=>true,
	'isUpload'=>true,'UrlUpload'=>'index.php?r=catalogsys/upload',
...
'selectableRows'=>1,
	...
	array('name'=>'catalogsysid','visible'=>false, 'value'=>'$data->catalogsysid','htmlOptions'=>array('width'=>'1%')),
	array('name'=>'languageid', 'value'=>'$data->language->languagename','htmlOptions'=>array('width'=>'1%')),
		'catalogname',
		'catalogval',
		array(
      'class'=>'CCheckBoxColumn',
