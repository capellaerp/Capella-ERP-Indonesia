...
function adddata()
{jQuery.ajax({'url':'/index.php?r=absschedule/create','data':$(this).serialize(),'type':'post','dataType':'json','success':function(data)
...
<script type="text/javascript">
function editdata()
{jQuery.ajax({'url':'/index.php?r=absschedule/update','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
{document.getElementById('messages').innerHTML='';if(data.status=='success')
...
<script type="text/javascript">
function deletedata()
{jQuery.ajax({'url':'/index.php?r=absschedule/delete','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
...
function helpdata(value) {
	jQuery.ajax({
        'url': '/index.php?r=absschedule/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/index.php?r=absschedule/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<?php
$this->widget('application.extensions.tipsy.Tipsy', array(
  ...
  'items' => array(
    array('id' => '#stat_name'
     ,'fallback' => Catalogsys::model()->getcatalog('enterabsschedulename'),'html'=>true),    
    array('id' => array('model' => $model, 'attribute' => 'absschedulename')
     ,'fallback' => Catalogsys::model()->getcatalog('enterabsschedulename'),'html'=>true),    
    array('id' => array('model' => $model, 'attribute' => 'absin')
     ,'fallback' => Catalogsys::model()->getcatalog('enterabsin'),'html'=>true),    
    array('id' => array('model' => $model, 'attribute' => 'absout')
     ,'fallback' => Catalogsys::model()->getcatalog('enterabsout'),'html'=>true),    
...
<?php $this->endWidget();?>
<h1><?php echo Catalogsys::model()->GetCatalog('absschedule') ?></h1>
<?php
$this->widget('ToolbarButton',array('isCreate'=>true,'isEdit'=>true,'isDelete'=>true,
	'isUpload'=>true,'UrlUpload'=>'index.php?r=absschedule/upload',
