...
function helpdata(value) {
	jQuery.ajax({
        'url': '/index.php?r=purchasinggroup/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
$this->widget('ToolbarButton',array('isCreate'=>true,'isEdit'=>true,'isDelete'=>true,
	'isUpload'=>true,'UrlUpload'=>'index.php?r=purchasinggroup/upload',
...
$this->widget('application.extensions.tipsy.Tipsy', array(
  ...
  'gravity' => 'n',
  'items' => array(
    array('id' => '#purchasingorgcode','fallback'=>Catalogsys::model()->getcatalog('enterpurchasingorgid'),'html'=>true),    
    array('id' => array('model' => $model, 'attribute' => 'purchasingorgid')
     ,'fallback' => Catalogsys::model()->getcatalog('enterpurchasingorgid'),'html'=>true),    
    array('id' => array('model' => $model, 'attribute' => 'purchasinggroupcode')
     ,'fallback' => Catalogsys::model()->getcatalog('enterpurchasinggroupcode'),'html'=>true),    
