...
<script type="text/javascript" >
	$(function(){
		...
		new AjaxUpload(btnUpload, {
			action: 'index.php?r=plant/upload',
			name: 'uploadfile',
...
function downloaddata() {
	window.open('/index.php?r=plant/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<?php
$this->widget('application.extensions.tipsy.Tipsy', array(
  ...
  'gravity' => 'n',
  'items' => array(
    array('id' => array('model' => $model, 'attribute' => 'plantcode')
     ,'fallback' => Catalogsys::model()->getcatalog('enterplantcode'),'html'=>true),    
...
$this->widget('ToolbarButton',array('isCreate'=>true,'isEdit'=>true,'isDelete'=>true,
	'isUpload'=>true,'UrlUpload'=>'index.php?r=plant/upload',
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	array('name'=>'plantid', 'visible'=>false,'header'=>'ID','value'=>'$data->plantid','htmlOptions'=>array('width'=>'1%')),
	array('name'=>'plantcode', 'value'=>'$data->plantcode'),
	'description',
    array(
      'class'=>'CCheckBoxColumn',
      'name'=>'recordstatus',
