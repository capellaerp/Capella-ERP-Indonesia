...
$this->widget('ToolbarButton',array(
	'isSave'=>true,'UrlSave'=>'customer/write',
	'isCancel'=>true,'UrlCancel'=>'customer/cancelwrite'
));
?>
          ...
          $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns'=>array(
              ...
              /* Here is The Button that will send the Data to The MAIN FORM */
                ...
                "id" => "send_addresstype",
                "onClick" => "$(\"#account_dialog\").dialog(\"close\"); $(\"#acchutangname\").val(\"$data->accountname\"); $(\"#Customer_acchutanghid\").val(\"$data->accountid\");"))',
                ),
