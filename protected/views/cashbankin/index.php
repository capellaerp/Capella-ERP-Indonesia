...
function adddata() {
    jQuery.ajax({
        'url': '/index.php?r=cashbankin/create',
        'data': $(this).serialize(),
        'type': 'post',
        'dataType': 'json',
...
function editdata() {
    jQuery.ajax({
        'url': '/index.php?r=cashbankin/update',
        'data': {
...
<script type="text/javascript">
function deletedata()
{jQuery.ajax({'url':'/index.php?r=cashbankin/delete','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json','success':function(data)
{},'cache':false});;$.fn.yiiGridView.update('datagrid');return false;}
</script>
<script type="text/javascript">
function approvedata()
{jQuery.ajax({'url':'/index.php?r=cashbankin/approve','data':{'id':$.fn.yiiGridView.getSelection("datagrid")},'type':'post','dataType':'json',
'success':function(data)
{
...
function helpdata(value) {
    jQuery.ajax({
        'url': '/index.php?r=cashbankin/help',
        'data': {
            'id': value
        },
        'type': 'post',
...
function downloaddata() {
	window.open('/index.php?r=cashbankin/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<script type="text/javascript">
function showdetail() {
...
?>
<h1><?php echo Catalogsys::model()->GetCatalog('cashbankin') ?></h1>
<?php
...
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'datagrid',
	'dataProvider'=>$model->Searchwfinstatus(),
	'filter'=>$model,
    'selectableRows'=>1,
	...
	array('name'=>'cashbankinid', 'visible'=>false,'header'=>'ID','value'=>'$data->cashbankinid','htmlOptions'=>array('width'=>'1%')),
	array(
      'name'=>'transdate',
      'type'=>'raw',
