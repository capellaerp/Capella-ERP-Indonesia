...
<script type="text/javascript" >
	$(function(){
		...
		new AjaxUpload(btnUpload, {
			action: 'index.php?r=romawi/upload',
			name: 'uploadfile',
...
function downloaddata() {
	window.open('/index.php?r=romawi/download&id='+$.fn.yiiGridView.getSelection("datagrid"));
}
</script>
<?php
$this->widget('application.extensions.tipsy.Tipsy', array(
  ...
  'gravity' => 'n',
  'items' => array(
    array('id' => array('model' => $model, 'attribute' => 'monthcal')
     ,'fallback' => Catalogsys::model()->getcatalog('entermonthcal'),'html'=>true),    
    array('id' => array('model' => $model, 'attribute' => 'monthrm')
     ,'fallback' => Catalogsys::model()->getcatalog('entermonthrm'),'html'=>true),    
...
$this->widget('ToolbarButton',array('isCreate'=>true,'isEdit'=>true,'isDelete'=>true,
	'isUpload'=>true,'UrlUpload'=>'index.php?r=romawi/upload',
...
$this->widget('zii.widgets.grid.CGridView', array(
  ...
  'selectableRows'=>1,
	...
	array('name'=>'romawiid','visible'=>false, 'header'=>'ID','value'=>'$data->romawiid','htmlOptions'=>array('width'=>'1%')),
		'monthcal',
		'monthrm',
    array(
      'class'=>'CCheckBoxColumn',
