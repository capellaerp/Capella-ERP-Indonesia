    ...
    public function actionWrite()
	{
	  ...
	  if(isset($_POST['Catalogsys']))
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Catalogsys']['languageid'],'sctemptylanguage','emptystring'),
                array($_POST['Catalogsys']['catalogname'],'sctemptycatalogname','emptystring'),
                array($_POST['Catalogsys']['catalogval'],'sctemptycatalogval','emptystring'),
            )
        );
        if ($messages == '') {
