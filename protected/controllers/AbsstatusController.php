...
class AbsstatusController extends Controller
{
    ...
    {
      $this->DeleteLockCloseForm($this->menuname, $_POST['Absstatus'], $_POST['Absstatus']['absstatusid']);
    }
	...
	public function actionWrite()
	{
	  ...
	  if(isset($_POST['Absstatus']))
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Absstatus']['shortstat'],'emptyshortstat','emptystring'),
  ...
  public function actionDownload()
  {
    ...
    $sql = "SELECT * FROM absstatus a ";
		...
		{
		  $this->pdf->row(array($row1['shortstat'],$row1['longstat'],
		  ($row1['isin']==1)?'V':'',$row1['priority']));
		}
		$this->pdf->Output();
  }
