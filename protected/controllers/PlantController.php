	 ...
	 $folder=$_SERVER['DOCUMENT_ROOT'].Yii::app()->request->baseUrl.'/upload/';// folder for uploaded files
		...
		{ 
			...
			if (($handle = fopen($file, "r")) !== FALSE) 
			{
				...
				{
					if ($row>0) {
			  $model=Plant::model()->findByPk((int)$data[0]);
			  if ($model=== null) {
				$model = new Plant();
			  }
			  $model->plantid = (int)$data[0];
			  $model->plantcode = $data[1];
...
public function actionDownload()
	{
		...
		$sql = "select a.plantcode, a.description
				from plant a ";
		if ($_GET['id'] !== '') {
		...
		$this->pdf->Row(array('Plant Code','Description'));
