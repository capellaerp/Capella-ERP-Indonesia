	...
	public function actionWrite()
	{
	  ...
	  if(isset($_POST['Educationmajor']))
	  {
        $messages = $this->ValidateData(
                array(array($_POST['Educationmajor']['educationid'],'emptyeducationname','emptystring'),
array($_POST['Educationmajor']['educationmajorname'],'emptyeducationmajorname','emptystring'),
                )
        );
        if ($messages == '') {
