...
class Occupation extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('occupationname, recordstatus', 'required'),
			array('recordstatus', 'numerical', 'integerOnly'=>true),
			array('occupationname', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('occupationid, occupationname, recordstatus', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'employeefamilys' => array(self::HAS_MANY, 'Employeefamily', 'occupationid'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('occupationid',$this->occupationid);
