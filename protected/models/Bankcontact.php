 ...
 */
class Bankcontact extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'addressbook' => array(self::BELONGS_TO, 'Bank', 'addressbookid'),
...
$model=new Bankcontact('search');
$model->attributes = $_GET['Bankcontact'];
