...
$model=new Customeraddress('search');
$model->attributes = $_GET['Customeraddress'];
$criteria->condition='addressbook.isCustomer=1 and t.addressbookid='.$model->addressbookid;
} else {
$criteria->condition='addressbook.isCustomer=1 and t.addressbookid=0';
}  
...
'pagination'=>array(
  ...
  /**
	...
	public function searchwstatus()
	{
		...
		$criteria=new CDbCriteria;
    $criteria->with=array('addressbook','addresstype','city','kelurahan','subdistrict');
    $criteria->condition='t.recordstatus=1 and addressbook.isCustomer=1';
		$criteria->compare('addressid',$this->addressid);
