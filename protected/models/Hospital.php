...
class Hospital extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('addressbookid, fullname, iscustomer, isemployee, isapplicant, isvendor, ishospital, isbank, isinsurance, recordstatus,accpiutangid', 'safe', 'on'=>'search'),
		);
	}
    ...
    $criteria->condition='ishospital=1';
...
'pagination'=>array(
  ...
  /**
	...
	public function searchwstatus()
	{
		...
		$criteria=new CDbCriteria;
        $criteria->with=array('accpiutang');
    $criteria->condition='ishospital=1 and t.recordstatus=1';
		$criteria->compare('addressbookid',$this->addressbookid);
		$criteria->compare('fullname',$this->fullname,true);
		$criteria->compare('iscustomer',$this->iscustomer);
		$criteria->compare('isemployee',$this->isemployee);
