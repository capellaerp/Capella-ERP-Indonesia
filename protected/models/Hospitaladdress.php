 ...
 * @property HospitalAddressbook $addressbook
 * @property City $city
 * @property Subdistrict $subdistrict
 * @property HospitalAddresstype $addresstype
 */
class Hospitaladdress extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Hospitaladdress the static model class
	 */
...
$model=new Hospitaladdress('search');
$model->attributes = $_GET['Hospitaladdress'];
