...
if (isset($_GET['Employeeinformal'])) {
			$criteria->condition='iswo=0 and t.employeeid ='.$_GET['Employeeinformal']['employeeid'];
		} else {
			$criteria->condition='iswo=0 and t.employeeid=0';
		}
...
$criteria->condition='t.recordstatus=1 and iswo=0';
		$criteria->compare('employeeinformalid',$this->employeeinformalid);
