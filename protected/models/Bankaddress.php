 ...
 * @property BankAddressbook $addressbook
 * @property City $city
 * @property Subdistrict $subdistrict
 * @property BankAddresstype $addresstype
 */
class Bankaddress extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Bankaddress the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('addressid, addressbookid, addresstypeid, addressname, rt, rw, cityid, kelurahanid, subdistrictid, phoneno', 'safe', 'on'=>'search'),
		);
	}
...
$model=new Bankaddress('search');
$model->attributes = $_GET['Bankaddress'];
$criteria->condition='addressbook.isbank=1 and t.addressbookid='.$model->addressbookid;
} else {
$criteria->condition='addressbook.isbank=1 and t.addressbookid=0';
}
